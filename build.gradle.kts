...
val pre = 812 // from 601: not work requireAll(require ;from 609: npm react-share
...
//                @file:JsModule
                implementation(npm("react-share", "~5.1.0"))//https://www.npmjs.com/package/react-share
                implementation(npm("mui-nested-menu", "~3.4.0"))//https://www.npmjs.com/package/mui-nested-menu
                implementation(npm("ag-grid-community", "~32.1.0")) // https://www.npmjs.com/package/ag-grid-community
                implementation(npm("ag-grid-react", "~32.1.0"))
                implementation(npm("@ag-grid-community/styles", "~32.1.0"))
            }
        }
    }
}
...
tasks.withType<KotlinJvmCompile>().configureEach {
    compilerOptions {
        jvmTarget.set(JvmTarget.JVM_22) // set GOOGLE_RUNTIME_VERSION=jvmTarget  in CloudRun
