...
fun rowSelected() = { params: ParamsAG ->
    if (params.node.selected) {
        rowFieldsValueMap = rowFieldsValueMap.filter { !it.key.endsWith("_") }.toMutableMap() // delete NOTmodify column
...
fun cellDoubleClicked(editIcon: String) = { params: ParamsAG ->
    if (params.columnApi.getAllDisplayedColumns()[0].colId == params.column.colId) // first column
