...
var QUOTE_TYPE = ""
var mappingFun: (String, String)-> String = String::plus
fun fromJsonString(json: String, quoteType: String = "", mappingString: (String, String)-> String) = run {
    QUOTE_TYPE = quoteType
    mappingFun = mappingString
    Json.decodeFromString(KotlinxGenericMapSerializer, json)
}
//https://www.baeldung.com/kotlin/parse-json-without-data-class (5.)
object KotlinxGenericMapSerializer : KSerializer<Map<String, Any?>> {
    ...
    private fun JsonPrimitive.toScalarOrNull(): Any? = when {
        ...
        this.isString -> mappingFun(this.content, QUOTE_TYPE)
